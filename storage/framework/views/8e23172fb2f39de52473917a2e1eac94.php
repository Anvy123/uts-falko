...
<body id="page-top">
    ...
    <header class="masthead text-center text-white">
        <div class="masthead-content">
            <div class="container px-5">
                ...
                <a class="btn btn-primary btn-xl rounded-pill mt-5" href="<?php echo e(route('barang.index')); ?>">Lets GO</a>
            </div>
        </div>
        ...
        <div class="container px-5">
            <div class="row gx-5 align-items-center">
                <div class="col-lg-6 order-lg-2">
                    <div class="p-5"><img class="img-fluid rounded-circle" src="<?php echo e(Vite::asset('resources/images/falko.jpg')); ?>" alt="..." />
                    </div>
                </div>
    ...
    <section>
        <div class="container px-5">
            <div class="row gx-5 align-items-center">
                <div class="col-lg-6">
                    <div class="p-5"><img class="img-fluid rounded-circle" src="<?php echo e(Vite::asset('resources/images/valo.jpg')); ?>" alt="..." />
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="p-5">
    ...
    <section>
        <div class="container px-5">
            <div class="row gx-5 align-items-center">
                <div class="col-lg-6 order-lg-2">
                    <div class="p-5"><img class="img-fluid rounded-circle" src="<?php echo e(Vite::asset('resources/images/ml.jpg')); ?>" alt="..." />
                    </div>
                </div>
                <div class="col-lg-6 order-lg-1">
                    <div class="p-5">
...
<?php /**PATH C:\c0ding\uts-falko\resources\views/home.blade.php ENDPATH**/ ?>